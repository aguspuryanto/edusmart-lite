...
import { Plus, Search, Edit2, Trash2, School, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm">Kelola data kelas dan rombongan belajar.</p>
        </div>
        <button
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          ...
          >
            <h3 className="text-xl font-bold text-slate-900 mb-6">Tambah Kelas Baru</h3>
